...
class gsb_queue_2012_12_29_16_19_59 implements EntityInterface
{

   public function getTransitionTable(SchemaBuilder $builder)
    {
        $table = $builder->createTable("gsb_transition");
    ...
    {
        $table = $builder->createTable("gsb_queue");
    ...
    {
        $table = $builder->createTable("gsb_monitor");
